...
public class NudgeArrayAdapter extends ArrayAdapter<Nudge> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView recipientView = adaptedView.findViewById(nudgeRecipientText);
        TextView messageView = adaptedView.findViewById(nudgeMessageText);
        TextView sendDateView = adaptedView.findViewById(nudgeSendDateText);
        CardView discardButton = adaptedView.findViewById(deleteNudgeButton);
        CardView editButton = adaptedView.findViewById(editNudgeButton);
